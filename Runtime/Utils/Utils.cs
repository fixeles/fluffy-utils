...
namespace FPS
{
	public static class Utils
	{
		...
		{
			public static IEnumerable<Type> FindAllDerivedTypes(Type targetType)
			{
		...
		public static class Editor
		{
			...
			public static void TryCreateResourcesFolder()
			{
				if (!UnityEditor.AssetDatabase.IsValidFolder("Assets/FPS"))
					UnityEditor.AssetDatabase.CreateFolder("Assets", "FPS");

				if (!UnityEditor.AssetDatabase.IsValidFolder("Assets/FPS/Resources"))
					UnityEditor.AssetDatabase.CreateFolder("Assets/FPS", "Resources");
			}
		}
#endif
	}
